...
def testing_whole_page_scroll_vertical(_):
    ...
    scroll(go_down_percentage=325)
    __finds_mid_assert()
    scroll(go_down_percentage=300)
    __finds_end_assert()
...
def testing_whole_page_scroll_horizontal(_):
    __finds_start_assert()
    scroll(go_right_percentage=122.5)
    __finds_mid_assert()
    scroll(go_right_percentage=124)
    __finds_end_assert()
...
def testing_by_type_single_child_scroll_view_vertical(_):
    __finds_start_assert()
    scroll(go_down_percentage=325, what_to_scroll="SingleChildScrollView", scroll_type=ScrollType.BY_TYPE)
    __finds_mid_assert()
    scroll(go_down_percentage=300, what_to_scroll="SingleChildScrollView", scroll_type=ScrollType.BY_TYPE)
    __finds_end_assert()
...
def testing_by_type_single_child_scroll_view_horizontal(_):
    __finds_start_assert()
    scroll(go_right_percentage=122.5, what_to_scroll="SingleChildScrollView", scroll_type=ScrollType.BY_TYPE)
    __finds_mid_assert()
    scroll(go_right_percentage=124, what_to_scroll="SingleChildScrollView", scroll_type=ScrollType.BY_TYPE)
    __finds_end_assert()
...
def testing_by_type_list_view_horizontal(_):
    __finds_start_assert()
    scroll(go_right_percentage=122.5, what_to_scroll="ListView", scroll_type=ScrollType.BY_TYPE)
    __finds_mid_assert()
    scroll(go_right_percentage=130, what_to_scroll="ListView", scroll_type=ScrollType.BY_TYPE)
    __finds_end_assert()
...
def testing_semantic_horizontal(_):
    __finds_start_assert()
    scroll(go_right_percentage=122.5, what_to_scroll="SingleChildScrollView", scroll_type=ScrollType.BY_SEMANTIC)
    __finds_mid_assert()
    scroll(go_right_percentage=124, what_to_scroll="SingleChildScrollView", scroll_type=ScrollType.BY_SEMANTIC)
    __finds_end_assert()
...
def testing_key_vertical(_):
    __finds_start_assert()
    scroll(go_down_percentage=325, what_to_scroll="single_child_scroll_view", scroll_type=ScrollType.BY_KEY)
    __finds_mid_assert()
    scroll(go_down_percentage=300, what_to_scroll="single_child_scroll_view", scroll_type=ScrollType.BY_KEY)
    __finds_end_assert()
...
def testing_key_horizontal(_):
    __finds_start_assert()
    scroll(go_right_percentage=122.5, what_to_scroll="single_child_scroll_view", scroll_type=ScrollType.BY_KEY)
    __finds_mid_assert()
    scroll(go_right_percentage=124, what_to_scroll="single_child_scroll_view", scroll_type=ScrollType.BY_KEY)
    __finds_end_assert()
